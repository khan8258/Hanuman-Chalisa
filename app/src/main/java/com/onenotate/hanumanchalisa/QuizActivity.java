...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewQuestion = findViewById(R.id.text_view_question_palette);
        ...
        String message = getString(R.string.difficulty_easy);
        message += difficulty;
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            score++;
            String message = getString(R.string.current_score);
            message += score;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                textViewQuestion.setText(R.string.answer_correct1);
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText(R.string.answer_correct2);
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText(R.string.answer_correct3);
                break;
        }

        if (questionCounter < questionCountTotal) {
            buttonConfirmNext.setText(R.string.next_question);
        } else {
            buttonConfirmNext.setText(R.string.finish_game);
        }
